"""
Django settings for shortanswers project.
...
SECRET_KEY = 'gkd2xoq0b0+1y*+l^=$n*_7^np*vcb4q@$*89v8il5mwuas8&t'
...
ROOT_URLCONF = 'shortanswers.urls'
...
WSGI_APPLICATION = 'shortanswers.wsgi.application'
